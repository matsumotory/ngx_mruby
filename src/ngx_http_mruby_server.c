...
void ngx_mrb_server_class_init(mrb_state *mrb, struct RClass *class)
{
  ...
  class_server =
      mrb_define_class_under(mrb, class, "Server", mrb->object_class);
  mrb_define_method(mrb, class_server, "document_root",
                    ngx_mrb_get_server_var_docroot, MRB_ARGS_NONE());
  mrb_define_method(mrb, class_server, "path",
                    ngx_mrb_get_server_var_realpath_root, MRB_ARGS_NONE());
  mrb_define_method(mrb, class_server, "realpath_root",
                    ngx_mrb_get_server_var_realpath_root, MRB_ARGS_NONE());
}
